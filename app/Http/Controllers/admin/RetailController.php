...
class RetailController extends Controller
{
    ...
    public function index()
    {
        ...
        $btc= Applicant_form::orderBy("id", "desc")->where('target_sector', 'retail')->paginate(10);
        return view('admin.retail',compact('btc','user'));
    ...
    $btc = Applicant_form::findorFail($id);
      ...
      $btcss = Juryratings::where("userid",$btc->user_id)->get();
        return view('admin.retail.edit',compact('btc','btcss','review'));
    }
