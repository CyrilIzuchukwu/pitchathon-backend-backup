...
class GreenEconomyController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        $btc= Applicant_form::orderBy("id", "desc")->where('target_sector', 'green economy')->paginate(10);
        return view('admin.greeneconomy',compact('btc','user'));
    }
     ...
     public function edit($id)
    {
      ...
      $btcss = Juryratings::where("userid",$btc->user_id)->get();
        return view('admin.greeneconomy.edit',compact('btc','btcss','review'));
    }
