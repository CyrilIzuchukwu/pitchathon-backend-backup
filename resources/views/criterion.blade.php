...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    <body>
        ...
        <nav class="lg:px-12 md:px-3 font-poppin px-6 shadow sticky top-0 left-0 z-50 w-full bg-white border-gray-200"
            ...
            <!-- criterion section  -->
            <section>
                <div class="flex flex-col container mx-auto my-28 md:px-12 px-6">
                    <div class="flex-col gap-4 flex md:w-2/3 w-full p-3 ">
                        <div class="md:text-3xl text-2xl">
                            <h1 class="text-gradient">Selection Criteria</h1>
                        </div>
                        <div class="md:text-xl text-base font-medium">
                            <h3>To be selected for the Techmybiz Pitchathon, you
                                must
                                meet the following criteria:</h3>
                        </div>
                    </div>
                    <div class="flex flex-col gap-5">
                        <div class="shadow-xl ">
                            <div class="bg-gray-100 rounded-md">
                                <div class=" md:text-xl text-base p-5 md:px-16
                                            w-full">
                                    <p class="list-item"> Local Content: Must be
                                        developed
                                        by an innovation organization or startup registered in Nigeria.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="shadow-xl ">
                            <div class="bg-gray-100 rounded-md">
                                <div class=" md:text-xl text-base p-5 md:px-16
                                            w-full">
                                    <p class="list-item">Focal Sector Alignment: The solutions must be
                                        focused on one of the thematic areas – Green
                                        Economy, Retail or
                        ...
                        <div class="shadow-xl ">
                            <div class="bg-gray-100 rounded-md">
                                <div class=" md:text-xl text-base p-5 md:px-16
                                            w-full">
                                    <p class="list-item">Market Viability: Must demonstrate high market potential, scale potential and revenue stickiness.
                                    </p>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="bg-gray-100 rounded-md">
                                <div class=" md:text-xl text-base p-5 md:px-16
                                    ...
                                    <p class="list-item">
                                        ...
                                        Industry Impact Potential: Significance of problem the idea is
                                        solving. Does the solution have
                            ...
                            <div class="bg-gray-100 rounded-md">
                                <div class=" md:text-xl text-base p-5 md:px-16
                                    ...
                                    <p class="list-item">
                                        ...
                                        Team Qualification & Alignment: Does the team demonstrate domain expertise and experience? Do they complement each other adequately?
                        ...
                        <div class="shadow-xl ">
                            <div class="bg-gray-100 rounded-md">
                                <div class=" md:text-xl text-base p-5 md:px-16
                                            w-full">
                                    <p class="list-item">Design Thinking: Does the customer journey
                                        and the customer experience strategy
                                        intersect nicely with the target market?
                                    </p>
                                </div>
                            </div>
                        </div>
