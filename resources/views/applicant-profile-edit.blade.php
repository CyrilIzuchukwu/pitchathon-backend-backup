...
<section class="lg:col-span-5 w-full lg:w-auto flex flex-col items-start lg:p-0 p-4 gap-8 ">
    ...
    <main class="w-full flex lg:flex-row flex-col pt-4 justify-center items-center lg:justify-start lg:items-start">
        ...
        <form class="w-full mb-4" method="POST" action="{{ url('update-user') }}" enctype="multipart/form-data">
            @csrf
            <div class="col-span-3 flex flex-col md:px-12 px-3 md:gap-6 gap-8 w-full">
                <div class="w-full">
                    ...
                    <input value="{{ $user->name }}" class="shadow border-none text-primary rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary" type="text" name="name" value="{{ old('name') }}" />
                    @error('name')
                ...
                <div class="w-full">
                    ...
                    <input value="{{ $user->address }}" class="shadow border-none text-primary rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary" type="text" name="address" value="{{ old('address') }}" />
                    @error('address')
                    <p class="text-secondary mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="w-full">
                    ...
                    <input value="{{ $user->email }}" class="shadow border-none text-primary rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary" type="email" name="email" value="{{ old('email') }}" />
                    @error('email')
                    <p class="text-secondary mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="flex gap-3 md:flex-row flex-col">
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ $user->phone }}" type="number" name="phone" placeholder="" class="text-primary shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary">
                        @error('phone')
                        <p class="text-secondary mt-1">{{ $message }}</p>
                        @enderror
                    </div>
  <div class="w-full">
                        <label class="block text-primary mb-2 ml-3 ">target_sector<span class="text-secondary">*</span></label>
                        <input value="{{ $user->target_sector }}" type="text" name="target_sector" placeholder="" class="text-primary shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary">
                        @error('target_sector')
                        <p class="text-secondary mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex gap-3 md:flex-row flex-col">
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ $user->country }}" type="text" name="country" placeholder="" class="text-primary shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary">
                        @error('country')
                        <p class="text-secondary mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ $user->organization }}" type="text" name="organization" placeholder="" class="text-primary shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary">
                        @error('organization')
                        <p class="text-secondary mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex gap-3 md:flex-row flex-col">
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex">
                            ...
                            <input value="{{ $user->twitter }}" type="text" name="twitter" placeholder="" class="text-primary shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary" aria-label="Recipient's username" aria-describedby="basic-addon2">
                            @error('twitter')
                            <p class="text-secondary mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex">
                            ...
                            <input value="{{ $user->facebook }}" type="text" name="facebook" placeholder="" class="text-primary shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary" aria-label="Recipient's username" aria-describedby="basic-addon2">
                            @error('facebook')
                            <p class="text-secondary mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="flex gap-3 md:flex-row flex-col">
                    ...
                    <div class="w-full">
                        ...
                        <div class="flex">
                            ...
                            <input value="{{ $user->linkedin }}" type="text" name="linkedin" placeholder="" class="text-primary shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary" aria-label="Recipient's username" aria-describedby="basic-addon2">
                            @error('linkedin')
                            <p class="text-secondary mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                ...
                <div class="flex gap-3 md:flex-row flex-col">
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ $user->profile_image }}" type="file" name="profile_image" placeholder="" class="text-primary shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary">
                        @error('profile_image')
                        <p class="text-secondary mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="flex gap-3 md:flex-row flex-col">
                    ...
                    <div class="w-full">
                        ...
                        <input value="{{ $user->profession }}" type="text" name="profession" placeholder="" class="text-primary shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary">
                        @error('profession')
                        <p class="text-secondary mt-1">{{ $message }}</p>
                        @enderror
                    </div>
                ...
                <div class="w-full">
                    ...
                    <input value="{{ $user->question }}" class="shadow border-none text-primary rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary" type="text" name="question" />
                    @error('question')
                    <p class="text-secondary mt-1">{{ $message }}</p>
                    @enderror
                </div>
                <div class="w-full">
                    ...
                    <textarea class="shadow border-none text-primary rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary" name="about_yourself" rows="10">{{ $user->about_yourself }}</textarea>
                ...
                <div class="w-full">
                    ...
                    <textarea class="shadow border-none text-primary rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary" name="about_business" rows="10">{{ $user->about_business }}</textarea>
