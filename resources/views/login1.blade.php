...
@section('content')
    ...
    <div class="md:mt-20 mt-0">
        <div class="w-full h-screen flex items-center
                justify-center">
            <form class="max-w-lg mx-auto xs:mt-20 w-3/4 mb-6 max-h-full" name="myForm" method="POST" action="{{ url('logins2') }}">
                @csrf
         ...
         <div class="w-full mt-6">
                    <div class="flex items-center rounded">
                    <input type="text" placeholder="Unique_code" class=" form-control @error('code') is-invalid @enderror w-full border rounded px-3 py-2 text-gray-700 focus:outline-none" name="code" value="" required >
