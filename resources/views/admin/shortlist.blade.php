...
@section('content')
    ...
    <section class="lg:col-span-5 w-full lg:w-auto  flex-col items-start pl-3 lg:pr-8 pr-3  gap-8">
        ...
        <!--{{-- <form method="POST" action="{{ url('shortlistss') }}"-->
        ...
        <!--    @csrf-->
            ...
            <!--        Shortlisted <span class="text-gradient">Solutions</span></h1>-->
            <!--    @if ($product == 1)-->
            <!--        <button type="submit"-->
        ...
        <div class="relative overflow-x-auto">
            <div class="w-full flex  items-center px-4" data-aos="fade-up" data-aos-duration="1000">
                ...
                <!--<br /><br />-->
                <form id="filter-form" action="" method="GET" class="flex justify-start gap-2 items-center"
                            ...
                            <tr
                                ...
                                <th scope="row"
                                    ...
                                    <h3 class="text-base font-medium hover:underline"
                                        data-modal-target="businessName{{ $loop->index }}"
                                        data-modal-toggle="businessName{{ $loop->index }}">{{ $item->business }}
                                    </h3>
                                    <span class="text-sm font-light hover:underline"
                                        data-modal-target="profileName{{ $loop->index }}"
                                            ...
                                            <div class="relative bg-white rounded-lg shadow md:pb-8 pb-3">
                                                ...
                                                <div class="py-6 px-4 w-full md:h-96 h-4/5">
                                                    <div class="relative overflow-auto mt-8 h-full">
                                                        <table
                                                            class="w-full h-full text-sm text-center text-primary border border-primary">
                                                            <thead class="text-xs uppercase bg-primary text-white">
                                                                <tr>
                                                                    <th scope="col"
                                                            ...
                                                            <tbody>
                                                                ...
                                                                @forelse ($reviewCount as $item_two)
                                                                ...
                                                                @empty
                                                                    <tr>
                                                                        <td colspan="7">No Applicant Reviewed yet
                                                                        </td>
                                                                    </tr>
                                                                @endforelse
                                                            </tbody>
                                        ...
                                        <div class="relative w-full h-full max-w-2xl md:h-auto">
                                            <div class="relative bg-white rounded-lg shadow">
                                                ...
                                                <div class="pt-12 pb-6 px-6">
                                                    ...
                                                    <!--    <tr>-->
                                                    <!--        <td style="word-wrap: break-word; text-align:left; white-space: normal;">My name is {{ $item->user->name }}, and my business-->
                                                    <!--            name-->
                                                    <!--            is {{ $item->business }}. My name is {{ $item->user->name }}, and my business-->
                                                    <!--            name-->
                                                    <!--            is {{ $item->business }}.</td>-->
                                                    <!--    </tr>-->
                                                    <!--</table>-->
                                                    <p style="white-space: normal;" class="text-base text-primary font-light text-justify">
                                                        My name is {{ $item->user->name }}, and my business
                                                                name
                                                                is {{ $item->business }}.</td>
                                                        </p>
                                                </div>
                                ...
                                <td class="px-6 py-2">
                                    @if ($item->status == 2)
                                        <a onclick="checker1()" href="{{ url('shortlistsss/' . $item->user->id) }}"> <button type="button"
                                                class="py-2 px-4  text-sm items-center gap-2 bg-gradient-to-r from-secondary to-primary rounded-lg text-white">Unselect</button></a>
                                                                                   <script>
    function checker1(){
        var result = confirm('Please do you want to unselect this Shortlisted Applicant.?');
        if(result == false){
            event.preventDefault();
        }
    }
</script>
                                        <!--<form action="{{ url('shortlistsss/' . $item->user->id) }}"-->
                                        <!-- Main modal -->
                                        ...
                                        <!--                    Please do you want to unselect this Shortlisted Applicant.-->
                                        <!--                </p>-->
                                        <!--            </div>-->
                                        <!--            Modal footer-->
                                        <!--            <div-->
                                    ...
                                    @elseif($item->status == 1)
                                        ...
                                        {{-- <!--<a href="{{ url('shortlists/' . $item->user->id) }}" class="py-2 px-4  text-sm items-center gap-2 bg-primary from-secondary to-primary rounded-lg text-white">Select</a> --> --}}
                                    @endif
                    ...
                    @empty
                        <tr>
                            <td colspan="7">No Shortlisted Applicant</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
        ...
        <!--                    <div-->
        <!--                        class="flex items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">-->
        <!--                        <form action="{{ url('shortlistsss/' . $item->user->id) }}" method="POST"-->
        <!--                            class="flex justify-start gap-2 items-center" data-aos="fade-up">-->
        <!--                            @csrf-->
        <!--                            <button-->
        <!--                                class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900 focus:z-10 dark:bg-gray-700 dark:text-gray-300 dark:border-gray-500 dark:hover:text-white dark:hover:bg-gray-600 dark:focus:ring-gray-600"-->
        <!--                                type="submit">Yes</button>-->
