...
@section('content')
                    ...
                    <div class="w-full flex flex-col gap-5">
                        ...
                        <div class="w-full grid md:grid-cols-4 gap-5">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" name="input-box" value="{{ ucfirst($btc->country_of_operation) }}"
                                    class="shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary"readonly>
                            </div>
                        ...
                        <div class="w-full grid md:grid-cols-3 gap-5">
                            ...
                            <div class="w-full">
                              ...
                              <button  class="py-2 px-4 flex text-sm items-center gap-2 bg-gradient-to-r from-secondary to-primary rounded-lg text-white">   <a href = "{{ $btc->solution_url }}" target="_blank">View</a></button>
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <button  class="py-2 px-4 flex text-sm items-center gap-2 bg-gradient-to-r from-secondary to-primary rounded-lg text-white">   <a href = "https://www.techmybiz.org/storage/{{ $btc->pitch_deck }}" target="_blank">View</a></button> 
                         ...
                         <div class="w-full grid md:grid-cols-2 gap-5">
                            ...
                            <div class="w-full">
                                ...
                                <!--    class="shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary"readonly>-->
                                    <textarea id="message" rows="5"
                                class="block p-2.5 w-full text-sm text-primary bg-gray-100 border-none shadow rounded-md text-justify focus:outline focus:outline-primary resize-none"readonly>{{ $btc->participation_reason }}</textarea>
                            </div>
 ...
 <button  class="py-2 px-4 flex text-sm items-center gap-2 bg-gradient-to-r from-secondary to-primary rounded-lg text-white">   <a href = "{{ $btc->video_pitch }}"  target="_blank">View </a></button>
                                <!--<input type="text" value="{{ $btc->video_pitch }}" name="input-box" http://www.techmybiz.org/storage/videos/rJtOi9ztHFbryKftcfcGjaGXjQsFqOnYXOKDO1CD.mp4-->
                                <!--    class="shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary"readonly>-->
                            </div>
                        </div>
