                        ...
                        <div class="w-full grid md:grid-cols-3 gap-5">
                            ...
                            <div class="w-full">
                                <label for="input-box" class="block text-primary mb-2 ml-3 ">Solution URL</label>
                                    ...
                                    <button>   <a href = "{{ $btc->solution_url }}" target="_blank">View URL </a></button>
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <button>   <a href = "http://www.techmybiz.org/storage/{{ $btc->pitch_deck }}" target="_blank">View Applicant Pdf</a></button> 
                            </div>
                        </div>
                         ...
                         <div class="w-full grid md:grid-cols-2 gap-5">
                           ...
                           <button  class="py-2 px-4 flex text-sm items-center gap-2 bg-gradient-to-r from-secondary to-primary rounded-lg text-white">   <a href = "http://www.techmybiz.org/storage/{{ $btc->video_pitch }}"  target="_blank">Solution URL </a></button>
                            </div>
                        </div>
