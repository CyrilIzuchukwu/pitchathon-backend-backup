...
<button  class="py-2 px-4 flex text-sm items-center gap-2 bg-gradient-to-r from-secondary to-primary rounded-lg text-white">   <a href = "http://www.techmybiz.org/storage/{{ $btc->video_pitch }}"  target="_blank">Video Link </a></button>
