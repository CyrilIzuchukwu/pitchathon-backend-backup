...
<section class="lg:col-span-5 w-full lg:w-auto flex flex-col items-start pl-3 lg:pr-8 pr-3  gap-8">
    ...
    <main class="w-full flex flex-col gap-3 lg:my-8 my-4 lg:pr-8 md:pr-2 pr-1" data-aos="fade-up" data-aos-duration="1000">
        ...
        <h1 class=" lg:text-2xl text-base text-left font-medium text-primary" data-aos="fade-up" data-aos-duration="1000">Reviewed<span class="text-gradient"> Solutions</span></h1>
        @forelse ($btc as $item)
        @if ($item->reviewerid == $item->reviewerid)
        <!-- card  -->
        <section class="w-full flex flex-col gap-3 py-5 px-5 rounded-md mt-3 bg-slate-100">
            <div class="w-full md:flex grid grid-cols-3 flex-row items-center md:gap-3 " data-aos="fade-up" data-aos-duration="1000">
                <!--<div class="w-16 h-16">-->
                ...
                <div class="flex col-span-2 flex-wrap items-center gap-3">
                    ...
                    <a href="{{ url('userManagementsss/'. $item->user->id) }}" class="text-white text-sm md:text-base bg-primary lg:px-5 px-3 rounded py-1.5 flex items-center">View
                        Solution</a>
                </div>
            </div>
            <!-- About text for user  -->
