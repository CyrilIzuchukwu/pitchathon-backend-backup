...
<!--                        data-aos-duration="1000">Applicant’s Solutions</h1>-->

                    <!-- filter  input -->
<!--                    <form action="" method="GET" class="flex justify-start gap-2 items-center" data-aos="fade-up"-->
<!--                        data-aos-duration="1000">-->
...
<!--                        </select>-->
<!--                        <button type="submit" class="text-white text-sm md:text-base bg-primary lg:px-5 px-3 rounded py-1.5 flex items-center">Filter</button>-->
<!--                    </form>-->
...
<!--                                <h4-->
<!--                                    class="text-secondary capitalize text-sm md:text-base bg-secondary/20 lg:px-5 px-3 rounded py-1.5">-->
<!--                                   {{ $item->target_sector }}</h4>-->

<!--                                <a href="{{ url('Review/review/' . $item->id) }}"-->
<!--                                    class="text-white text-sm md:text-base bg-primary lg:px-5 px-3 rounded py-1.5 flex items-center">Review-->
<!--                                    Solution</a>-->
<!--                            </div>-->
<!--                        </div>-->
                        <!-- About text for user  -->
 ...
 <!-- Main modal -->
                ...
                <!-- Modal content -->
                    ...
                    <!-- Modal body -->
                            <div>
                                <h1>👇</h1>
                                <a href="/Review/settings" id="modalText">Click
