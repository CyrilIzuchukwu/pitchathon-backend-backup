...
@section('content')
            ...
            <section
                ...
                <main class="w-full flex flex-col md:gap-4 gap-7 items-center py-4" data-aos="fade-up"
                    ...
                    <h1 class=" lg:text-2xl text-xl font-medium text-primary">City Empire</h1>
                     ...
                     <div class="w-full flex flex-col gap-5">
                        ...
                        <div class="w-full grid md:grid-cols-4 gap-5">
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" value="{{ ucfirst($btc->country_of_operation) }}" name="input-box"
                                    class="shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary"readonly>
                            </div>
                        ...
                        <div class="w-full grid md:grid-cols-2 gap-5">
                            ...
                            <div class="w-full">
                                <label for="input-box" class="block text-primary mb-2 ml-3 ">What was your total revenue
                                    last year?</label>
                                <input type="tel" value="{{ $btc->name_of_business }}" name="input-box"
                                    class="shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary"readonly>
                            </div>
                            ...
                            <div class="w-full">
                                ...
                                <input type="text" value="{{ ucfirst($btc->target_sector) }}" name="input-box"
                                    class="shadow border-none rounded-md w-full py-3 px-3 bg-gray-100 leading-tight focus:outline focus:outline-primary"readonly>
                            </div>
                        </div>
                        ...
                        <div class="w-full">
                            <label for="input-box" class="block text-primary mb-2 ml-3 capitalize">What impact will your
                                solution
                                have on MSMEs? </label>
                        ...
                        <div class="w-full grid md:grid-cols-5 gap-5">
                            ...
                            <div class="w-full flex flex-col justify-end">
                                <label for="input-box" class="block text-primary mb-2 ml-3 ">How long have you
                                    been
                                    operational?</label>
    ...
    background: linear-gradient(173deg, #a13193, #000000b8);
...
">    <a href = "{{ $btc->video_pitch }}"  target="_blank">View </a></button>
                    ...
                    <section
                        ...
                        <main class="w-full flex flex-col items-start">
                            ...
                            <section class="w-full grid md:grid-cols-2 mt-8 md:border-y border-b border-primary ">
                               ...
                               @endforelse
                                ...
                                <!--                <h2 class="text-sm text-primary font-medium">Local Content</h2>-->
                                <!--                <input type="text"-->
                                <!--                    class="border-none w-9  text-sm font-light rounded-md bg-gray-50 py-1 px-2 focus:outline focus:outline-primary">-->
                                <!--            </div>-->
                                <!--            <textarea rows="3"-->
                                <!--                class="block p-1.5 w-full text-sm text-primary bg-gray-50 border-none rounded-md text-left focus:outline focus:outline-primary resize-none"-->
                                <!--                placeholder="Enter reason for the grade allocated"></textarea>-->
                                <!--        </div>-->
                                ...
                                <!--            <h2 class="text-secondary text-base font-medium mb-2">Summary-->
                                <!--                Review</h2>-->
                                <!--            <p class="text-justify font-light text-primary text-sm">Massa risus,-->
                                <!--                imperdiet vestibulum, tristique nunc ut felis auctor quams cursus-->
                                <!--                tincidunt quis ultrices adipiscing magna-->
                                <!--                condimentum. Massa risus, imperdiet vestibulum, tristique nunc ut felis-->
                                <!--                auctor quams cursus tincidunt quis ultrices-->
                                <!--                adipiscing magna condimentum.</p>-->
                                <!--        </div>-->
                                <!--    </div>-->
                                <!--</div>-->
                            </section>
                        ...
                        <main class="w-full h-auto bg-primary rounded-md px-4 py-4">
                            <h1 class="lg:text-2xl text-base self-start font-medium text-secondary pb-6">Jury Report Assessment
                                Grid
                            </h1>
                             ...
                             @if(isset($btcss))
                             <form action="" class="w-full grid md:grid-cols-4 gap-4">
                  
                                <!-- Local Content -->
                                <div class="w-full flex flex-col gap-2">
                                    <div class="w-full flex items-center flex-wrap gap-2">
                                        <h2 class="text-sm text-slate-200 font-medium">Storytelling/Presentation</h2>
                                        <select name="score1"
                                ...
                                <div class="w-full flex flex-col gap-2">
                                    <div class="w-full flex items-center flex-wrap gap-2">
                                        <h2 class="text-sm text-slate-200 font-medium">Problem/Solution Fit</h2>
                                        <select name="score2"
                                            class="border-none text-sm font-light rounded-md bg-gray-50 py-1 px-2 focus:outline focus:outline-primary"disabled>
                                ...
                                <div class="w-full flex flex-col gap-2">
                                    <div class="w-full flex items-center flex-wrap gap-2">
                                        <h2 class="text-sm text-slate-200 font-medium">Traction</h2>
                                        <select name="score3"
                                            class="border-none text-sm font-light rounded-md bg-gray-50 py-1 px-2 focus:outline focus:outline-primary"disabled>
                                       <option value="{{ $btcss->scor3 }}">{{ $btcss->rate3 }}</option>
                                        </select>
                                    </div>
                                    <textarea rows="3"
                                        class="block p-1.5 w-full text-sm text-primary bg-gray-50 border-none rounded-md text-left focus:outline focus:outline-primary resize-none"
                                ...
                                <div class="w-full flex flex-col gap-2">
                                    <div class="w-full flex items-center flex-wrap gap-2">
                                        <h2 class="text-sm text-slate-200 font-medium">Defensibility</h2>
                                        <select name="score4"
                                            class="border-none text-sm font-light rounded-md bg-gray-50 py-1 px-2 focus:outline focus:outline-primary"disabled>
                                ...
                                <!--<div class="w-full flex flex-col gap-2">-->
                                <!--    <div class="w-full flex items-center flex-wrap gap-2">-->
                                <!--        <h2 class="text-sm text-slate-200 font-medium">Local Content</h2>-->
                                <!--        <select name="score5"-->
                                <!--            class="border-none text-sm font-light rounded-md bg-gray-50 py-1 px-2 focus:outline focus:outline-primary"disabled>-->
                                ...
                                <div class="md:col-span-4 flex flex-col">
                                    <label for="summary" class="text-slate-200 font-medium mb-2 ml-3 ">Jury Summary
                                        Review</label>
                            ...
                            @else
                             <form action="{{ url('Jury/post/'. $btc->id) }}" method="POST" class="w-full grid md:grid-cols-4 gap-4">
                                
                             @csrf
                        
                          @if ($errors->any())
        <div class="alert alert-warning text-center text-secondary"id="demos">
            ...
            element.remove();
                         ...
                         <input hidden text="text" value=" {{ $btc->name_of_business }}" name="business" readonly>
                                ...
                                <div class="md:col-span-4 flex flex-col">
                                    <label for="summary" class="text-slate-200 font-medium mb-2 ml-3 ">Jury Summary
                                        Review</label>
                                    <textarea name=summary rows="6"  value="{{ old('summary') }}"
                                        class="block p-2 w-full text-sm text-primary bg-gray-50 border-none rounded-md text-left focus:outline focus:outline-primary resize-none"
                                        placeholder="Enter summary review that will be shared with applicant as feedback">{{ old('summary') }}</textarea>
                                </div>

                                <!-- Buttons  -->
                                <div class="md:col-span-4 flex flex-wrap justify-start items-center">

                                    <button type="submit"
                                        class="border border-slate-200 outline-none  bg-gradient-to-br from-primary to-secondary text-white text-sm py-2 px-4 rounded-md transition-all duration-300 hover:from-secondary hover:to-primary">Submit
                                        Assessment</button>
                                </div>
                            </form>
                              @endif
