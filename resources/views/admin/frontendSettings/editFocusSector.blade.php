    ...
    <main class="w-full grid lg:grid-cols-1 md:grid-cols-1 gap-3 mb-10 lg:pt-8 lg:pr-8 md:pr-2 pr-1" data-aos="fade-up" data-aos-duration="1000">
        ...
        <div class="md:mt-20 mt-0 w-full" style="box-shadow: rgba(0, 0, 0, 0.4) 0px 2px 4px, rgba(0, 0, 0, 0.3) 0px 7px 13px -3px, rgba(0, 0, 0, 0.2) 0px -3px 0px inset; padding: 0px 30px 40px">
            ...
            <div class="w-full  items-center justify-center">
                <form class="max-w-lg mx-auto xs:mt-20 w-3/4 mb-6 max-h-full" method="POST" action="{{ url('admin/update_focus_sector', $data->id) }}" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="mt-6">
                        <div class="w-full gap-5">
                            <div class="w-full flex flex-col items-start">
                                <label for="" class="">Old Image</label>
                                <img src="/updates/{{$data->image}}" alt="" width="80">
                            </div>
                        </div>

                        <div class="w-full gap-5 mt-6">
                            <div class="w-full flex flex-col items-start">
                                <label for="" class="">New Image</label>
                                <input type="file" value="" name="image" class="w-full md:w-1/2 border rounded px-3 py-3 focus:outline text-gray-700 " />
                        ...
                        <div class="w-full gap-5 mt-4">
                            <div class="w-full flex flex-col items-start">
                                ...
                                <input type="text" value="{{ $data->img_title }}" name="img_title" class="w-full md:w-full border rounded px-3 py-4 focus:outline text-gray-700 " />
